    ...
    <div className="cookie">
      ...
      <ul>
        <li>
          ...
          this Cookies Policy) refers to BD.
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to BD, accessible from{" "}
          <a
            href="www.mebikash.in"
      ...
      <ul>
        <li>
          <p>By email: bikashd003@gmail.com</p>
        </li>
        <li>
          <p>
            By visiting this page on our website:{" "}
            <a
              href="www.mebikash.in/#contact"
              rel="external nofollow noopener"
              target="_blank"
            >
              www.mebikash.in/#contact
            </a>
          </p>
        </li>
        <li>
        By phone number: <a href="tel:+917003725063">7003725063</a>
        </li>
      </ul>
    </div>
  )
